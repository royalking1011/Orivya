...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const handleSearch = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (q) setLocation(`/shop?search=${encodeURIComponent(q)}`);
    ...
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <footer className="bg-black text-white py-16">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Luxury sustainable cosmetics designed to bring out your natural radiance. 
              Clean ingredients, premium quality.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2 text-sm text-gray-400">
              ...
              <Link href="/shop?category=sets">Gift Sets</Link>
        ...
        <div className="container mx-auto px-4 mt-16 pt-8 border-t border-white/10 text-center text-xs text-gray-500">
          © {new Date().getFullYear()} Orivya Eco Private Limited. All rights reserved.
        </div>
      </footer>
    </div>
  );
