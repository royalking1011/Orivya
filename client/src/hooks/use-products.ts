...
export function useProducts(filters?: { category?: string; search?: string; isCombo?: boolean }) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (filters) {
        ...
        if (filters.isCombo !== undefined) params.append("isCombo", String(filters.isCombo));
        url += `?${params.toString()}`;
      }
